...
## compress
path <- paste0(fpath, "Chip_multi.fst")
...
############################### getting peaks for egr1 motif sites in egr1 chipseq #######################
## define TF
TF = 'Egr1'
## read file
tf.dat <- read.table(paste0('/home/bsharmi6/NA_TF_project/scMethylome/ETRMS_dev_cell_sc/ChIP_seq_analysis/', TF, '/ETRM_analysis/egr1/egr1.txt'), h=T)
...
##save
save(res, file = paste0(fpath, '/ETRMS_dev_cell_sc/ChIP_seq_analysis/',TF, '/ETRM_analysis/egr1/', TF,'_res_fst.RData'))
...
## save
save(out.dat, file = paste0(fpath, '/ETRMS_dev_cell_sc/ChIP_seq_analysis/',TF,'/ETRM_analysis/egr1/',TF,'_peaks_methylation.RData'))
